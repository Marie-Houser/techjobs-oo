...
public class JobController {
    ...
    public String add(Model model, @Valid JobForm jobForm, Errors errors) {
            if (errors.hasErrors()){
                ...
                int locationId = Integer.parseInt(jobForm.getLocation().getValue());
                Location location = jobData.getLocations().findById(locationId);
                int positionTypeId = Integer.parseInt(jobForm.getPositionType().getValue());
                PositionType positionType = jobData.getPositionTypes().findById(positionTypeId);
                int coreCompetencyId = Integer.parseInt(jobForm.getCoreCompetency().getValue());
